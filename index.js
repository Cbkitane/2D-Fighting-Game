    ...
    if (isPlaying && !isGameOver) {
        if (!PLAYER01.classList.contains("isHitTaken")) {
            ...
            if (isMovingRight) {
                ...
                if (
                    x_position +
                        (PLAYER01.offsetWidth - widthDeduction + 100) >=
        ...
        if (!PLAYER02.classList.contains("isHitTaken")) {
            ...
            if (isMovingRight2) {
                ...
                if (
                    x_position2 +
                        (PLAYER02.offsetWidth - widthDeduction + 100) >=
                    CONTAINER.offsetWidth
                ) {
                    x_position2 =
                        CONTAINER.offsetWidth -
...
function attackAnimation() {
    if (isAttacking && !isHitTaken) {
        ...
        if (
            isHit(PLAYER01, PLAYER02) &&
            !PLAYER02.classList.contains("isHitTaken") &&
            !PLAYER01.classList.contains("isHitTaken")
        ) {
...
function isHit(player, enemy) {
    ...
    if (
        playerRect.bottom - heightDeduction - 50 < enemyRect.top ||
        playerRect.top > enemyRect.bottom - heightDeduction
    ) {
        return;
    }
